    ...
    <div className="min-w-0 flex-1 px-8 pt-[29px] pb-8">
      ...
      <div className="mt-6 flex flex-wrap justify-between gap-6">
        <ImprovedCard
          items={[
            {
              iconSrc: "/customer trust.svg",
              label: "Customer Trust",
              delta: 18,
            },
            {
              iconSrc: "/compliance safety.svg",
              label: "Compliance Safety",
              delta: 34,
            },
            {
              iconSrc: "/dataprotection.svg",
              label: "Data Protection",
              delta: 18,
            },
            {
              iconSrc: "/decision quality.svg",
              label: "Decision Quality",
              delta: 12,
            },
            {
              iconSrc: "/accoutability.png",
        ...
        <AttentionCard
          items={[
            {
              iconSrc: "/reputation risk.svg",
              label: "Reputation Risk",
              delta: 30,
            },
            {
              iconSrc: "/responsible banking.svg",
